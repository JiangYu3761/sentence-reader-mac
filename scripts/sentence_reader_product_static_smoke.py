...
REQUIRED = {
    ...
    RUNTIME_LAUNCH: [
        "ReaderRuntime",
        "Python3.framework",
        "bundled signed runtime python deps",
        "run_reader_api.sh",
    ...
    PACKAGE: [
        "ReaderRuntime",
        "copy_reader_runtime",
        "copy_bundled_python_runtime",
        "BUNDLED_RUNTIME_PYTHON",
        "write_runtime_manifest",
        "click.reader_runtime.manifest.v2",
        "sentence_reader_runtime_bootstrap.py",
        ...
        "bundled_signed_python_framework",
        "migrations",
    ...
    SWIFT: [
        ...
        "不删除托管原书、阅读位置、标红、笔记或 PostgreSQL 数据",
        "READER_API_HOST",
        "0.0.0.0",
        "SentenceReader.funASRPythonPath.v1",
        "SentenceReader.funASRWorkerPath.v1",
